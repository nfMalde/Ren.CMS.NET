...
(function(au, k) {
    ...
    function s(S, K) {
        return S.replace( /\{(\w+?)\}/g , function(aG, aH) { return K[aH]; });
    }
 ...
 */
    Q.find = (function() {
        ...
        var aM = aG.selectors = {
            ...
            filters: {
                enabled: function(aW) { return aW.disabled === false && aW.type !== "hidden"; },
            ...
            setFilters: { first: function(aX, aW) { return aW === 0; }, last: function(aY, aX, aW, aZ) { return aX === aZ.length - 1; }, even: function(aX, aW) { return aW % 2 === 0; }, odd: function(aX, aW) { return aW % 2 === 1; }, lt: function(aY, aX, aW) { return aX < aW[3] - 0; }, gt: function(aY, aX, aW) { return aX > aW[3] - 0; }, nth: function(aY, aX, aW) { return aW[3] - 0 === aX; }, eq: function(aY, aX, aW) { return aW[3] - 0 === aX; } },
            filter: {
        ...
        (function() {
            ...
            if (aW.firstChild && typeof aW.firstChild.getAttribute !== "undefined" && aW.firstChild.getAttribute("href") !== "#") {
                aM.attrHandle.href = function(aX) { return aX.getAttribute("href", 2); };
            }
            aW = null;
        })();
        ...
        var aN = document.compareDocumentPosition ? function(aX, aW) { return aX.compareDocumentPosition(aW) & 16; } : function(aX, aW) { return aX !== aW && (aX.contains ? aX.contains(aW) : true); };
        var aH = function(aW) {
    ...
    T.onReady = function(aH) {
        ...
        case "hw":
            ac(aG.innerHeight, aG.top, true, function() { ar(aG.width, aG.left, true, K); });
            break;
        case "wh":
            ar(aG.width, aG.left, true, function() { ac(aG.innerHeight, aG.top, true, K); });
            break;
        default:
